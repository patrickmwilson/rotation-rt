...
def getFace(showTarget, set):
    if set == 1:
        #target = 'face13.jpg'
        #distractors = ['face19.jpg', 'face20.jpg']
        target = 'robb.jpg'
        distractors = ['john snow.jpg', 'theon.jpeg']
    else:
        #target = 'face23.jpg'
        #distractors = ['face24.jpg', 'face25.jpg']
        target = 'cercei.jpg'
        distractors = ['danny.jpg', 'catlin.jpg']
...
if recordData:
    ...
    expName = 'Face Roll Rotation RT Familiar'
...
def practiceRound(set):
    ...
    displayImage.ori = referenceRotation
    feedbackRect.ori = referenceRotation
