...
def getFace(showTarget, set, rotation):
    if set == 1:
        target = 'Face 2'
        distractors = ['Face 3', 'Face 4']
    elif set == 2:
        target = 'Face 9'
        distractors = ['Face 10', 'Face 11']
    else:
        target = 'Face 12'
        distractors = ['Face 13', 'Face 14']
    ...
    face = (os.path.join(os.getcwd(), 'Stimuli', 'Faces', 'Yaw', faceNum, (str(int(rotation))+'.png')))
